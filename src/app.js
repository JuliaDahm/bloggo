...
const ngRoute = require('angular-route'); //now loaded on page. now have to tell app to use it in angular.module
...
angular.module('bloggo', [ ngRoute ]) //injecting this into module to tell angular to use this router
      .config(RoutesConfig)
